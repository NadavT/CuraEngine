...
public:
    ...
    VariableWidthInsets inset_paths;       //!< The insets represented as variable line-width paths. The insets are also known as perimeters or the walls.
...
public:
    ...
    VariableWidthInsets wall_toolpaths; //!< toolpaths for walls, will replace(?) the insets
    VariableWidthInsets infill_wall_toolpaths; //!< toolpaths for the infill area's
