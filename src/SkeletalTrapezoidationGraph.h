...
public:
    ...
    void makeRib(edge_t*& prev_edge, Point start_source_point, Point end_source_point, bool is_next_to_start_or_end, const std::unordered_map<Point, float>& width_factors);
