...
void SkeletalTrapezoidation::generateToolpaths(VariableWidthInsets& generated_toolpaths, bool filter_outermost_central_edges)
{
...
void SkeletalTrapezoidation::addToolpathSegment(const ExtrusionJunction& from, const ExtrusionJunction& to, bool is_odd, bool force_new_path, bool from_is_3way, bool to_is_3way)
{
    ...
    VariableWidthInsets& generated_toolpaths = *p_generated_toolpaths;
